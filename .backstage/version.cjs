...
let sitefixCfg = file("../sitefix/Cargo.toml");
sitefixCfg.contents = sitefixCfg.contents.replace(version_re, `version = "${version}"`);
fs.writeFileSync(sitefixCfg.path, sitefixCfg.contents);
